...
st.title("BILLtelligence.")
st.write("Intelligent way to process Invoices.")
...
prompt = ChatPromptTemplate.from_template(
    ...
    {context}
    <document>
    Provided Document, Extract the following details in a table:
    Customer details, Products, Total Amount
    """
)
